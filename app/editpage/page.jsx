...
const EditPage = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      const data = await getUserProfile(); // Assume this function fetches the user data
      setUserData(data);
    };
  ...
  useEffect(() => {
    if (userData) {
      setValue("industry", userData.industry.split("-")[0]);
      setValue("subIndustry", userData.industry.split("-")[1]?.replace(/-/g, " "));
  ...
  return (
    <div className="flex items-center justify-center bg-background">
      <Card className="w-full max-w-lg mt-10 mx-2">
        <CardHeader>
          <CardTitle className="gradient-title text-4xl">Edit Your Profile</CardTitle>
          <CardDescription>
